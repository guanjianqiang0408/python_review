# Generated by Django 2.0.7 on 2022-11-06 08:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(help_text='话题关联用户表', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created_time'],
                'abstract': False,
        ...
        migrations.AddField(
            model_name='comment',
            name='topic',
            field=models.ForeignKey(help_text='话题标题', on_delete=django.db.models.deletion.CASCADE, to='post.Topic'),
        ),
    ]
